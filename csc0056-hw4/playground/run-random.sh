...
# In this version we try to take random samples to estimate N
# To make random sampling work, we need to modify ./src/database.c and recompile the code
SAMPLES=5000
...
echo "Collecting $SAMPLES samples of N..."
