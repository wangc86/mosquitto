...
y = np.loadtxt('c:/Users/Chao Wang/code/inter-arrival_time.out1N')
...
ax1.set_xlim(-0.005, 3.8)
ax1.set_ylim(-0.02, 0.085)
ax1.set_xlabel('Inter-arrival time (second)')
ax1.set_ylabel('Probability density')
ax1.set_title('Probability Density Function (N=1)')
ax1.legend(loc=1)
...
ax2.set_xlim(-0.005, 3.8)
ax2.set_ylim(-0.02, 0.085)
